...
<head>
    ...
    <title>Đơn hàng của bạn đang giao </title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <h2>Đơn hàng của bạn đang được giao bởi Đỗ Mạnh Cường</h2>
        <p>Sđt : 0357451006</p>
        <p>Kiện hàng của bạn sẽ sớm được giao. Hãy để ý điện thoại nhé !</p>
