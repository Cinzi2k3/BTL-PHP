...
<body>
    ...
    <div class="le dam">Tên đơn vị bán hàng: Điện Máy Xanh </div>
    <!-- <div class="le">Mã số thuế: 3269289058</div> -->
    <div class="le">Địa chỉ: Khoái Châu, Dân Tiến, Hưng Yên</div>
    ...
    <table>
        ...
        @foreach($ctdh as $item)
            <tr>
                ...
                <td>{{$item -> SoLuong}}</td>
                <td>{{number_format($item -> ThanhTien, 0, '', ',')}}đđ</td>
                <td>{{number_format($item -> SoLuong * $item -> ThanhTien, 0, '', ',')}}đđ</td>
            </tr>
        @endforeach
        ...
        <tr>
            ...
            <td class="dam"><label id="tien">{{number_format($dh -> ThanhTien, 0, '', ',')}}đđ</label></td>
        </tr>
    </table>
